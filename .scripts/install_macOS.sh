...
ln -sf $DOTFILES_CONFIG/borders $XDG_CONFIG_HOME
ln -sf $DOTFILES_CONFIG/ghostty $XDG_CONFIG_HOME
ln -sf $DOTFILES_CONFIG/karabiner $XDG_CONFIG_HOME
# ln -sf $DOTFILES_CONFIG/kitty $XDG_CONFIG_HOME
ln -sf $DOTFILES_CONFIG/lazysql $XDG_CONFIG_HOME
...
ln -sf $DOTFILES_CONFIG/opencode $XDG_CONFIG_HOME
